...
/*
静态链接库
 arm-none-linux-gnueabi-gcc -o hello helloqemu.c -static
 $ qemu-arm ./hello
 $ file hello
...
arm-none-linux-gnueabi-gcc -o hello_1 helloqemu.c
...
-rwxr--r-- 1 nobody nogroup     72 Mar 26 16:08 helloqemu.c
