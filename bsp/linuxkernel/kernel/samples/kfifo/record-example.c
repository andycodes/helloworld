...
static int __init testfunc(void)
{
	...
	unsigned int	i;
	unsigned int	ret;
	struct fifo_data t_data, s_data;
	...
	kfifo_in(&test, &t_data, sizeof(struct fifo_data));
	printk(KERN_INFO "fifo len: %u\n", kfifo_len(&test));
	kfifo_in(&test, &t_data, sizeof(struct fifo_data));
	printk(KERN_INFO "fifo len: %u\n", kfifo_len(&test));
	kfifo_out(&test, &s_data, sizeof(struct fifo_data));
	printk(KERN_INFO "fifo len: %u\n", kfifo_len(&test));
	kfifo_out(&test, &s_data, sizeof(struct fifo_data));
	printk(KERN_INFO "fifo len: %u\n", kfifo_len(&test));
	pr_info("[%s][%d][%d][%d]\n", __func__, s_data.a, s_data.b, s_data.c);
	...
	printk(KERN_INFO "fifo kfifo_esize: %u\n", kfifo_esize(&test));
	printk(KERN_INFO "fifo kfifo_recsize: %u\n", kfifo_recsize(&test));
	printk(KERN_INFO "fifo kfifo_size: %u\n", kfifo_size(&test));//FIFO_SIZE
	printk(KERN_INFO "fifo len: %u\n", kfifo_len(&test));
