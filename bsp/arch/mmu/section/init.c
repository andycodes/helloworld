...
{
    unsigned int *pdwSrc  = (unsigned int *)2048; //led.o的加载地址在连接脚本中被指定2048;在镜像文件中的位置
...
#define MMU_SECTION_SIZE    0x00100000
	...
	unsigned long *mmu_tlb_base = (unsigned long *)0x30000000;/*物理地址  bank6	 支持SDRAM*/
	...
	*(mmu_tlb_base + (virtuladdr >> 20)) = (physicaladdr & 0xFFF00000) | MMU_SECDESC_WB;
	//*(mmu_tlb_base + (virtuladdr >> 20)) = *(TTB[31-14]+MVA[31-20]+00) = *(描述符地址)
