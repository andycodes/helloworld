...
static int __init hello_init(void)
 {
	 ...
	 driver_create_file(&s3c24xx_led_driver.driver,
...
static void __exit hello_exit(void)
 {
	/* Destroy sysfs files. */
	driver_remove_file(&s3c24xx_led_driver.driver,
			   &driver_attr_up_head_align);
...
alarmtimer  Fixed MDIO bus.0  pcspkr  reg-dummy  s3c24xx_led.0  uevent
eisa.0      i8042             power   rtc_cmos   serial8250     vesafb.0
